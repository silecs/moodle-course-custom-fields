...
class condition extends \core_availability\condition {
    ...
    protected function get_cached_user_profile_field($userid) {
        ...
        if ($iscurrentuser) {
            ...
            if ($iscustomprofilefield) {
                ...
                $data = $DB->get_field('custom_info_data', 'data', array('objectname' => 'user', 'objectid' => $userid,
    ...
    public function filter_user_list(array $users, $not, \core_availability\info $info,
        ...
        if ($this->customfield) {
            ...
            $values = $DB->get_records_select('custom_info_data', 'fieldid = ? AND objectname = \'user\' AND objectid ' . $sql,
    ...
    public function get_user_list_sql($not, \core_availability\info $info, $onlyactive) {
        ...
        if ($this->customfield) {
            ...
            $tablesql = "LEFT JOIN {custom_info_data} ud ON ud.fieldid = " .
                    ...
                    " AND ud.objectname = 'user' AND ud.objectid = userids.id";
